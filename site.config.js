const CONFIG = {
  ...
  projects: [
    {
      name: `morethan-log`,
      href: "https://github.com/rappire/morethan-log",
    },
  ],
  // blog setting (required)
  blog: {
    title: "rappire-blog",
    description: "welcome to rappire-blog!",
    scheme: "dark", // 'light' | 'dark' | 'system'
  },

  // CONFIG configration (required)
  link: "https://rappire.vercel.app",
  ...
  utterances: {
    enable: true,
    config: {
      repo: process.env.NEXT_PUBLIC_UTTERANCES_REPO || "rappire/comments",
      "issue-term": "og:title",
      label: "💬 Utterances",
    },
  },
